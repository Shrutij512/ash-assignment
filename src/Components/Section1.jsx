    ...
    return (
        <div className='secton-1'>
            ...
            <div className='text-white ml-[5%] mt-[5%] text-xl text-left'>
                ...
                <div className='mt-6 w-[60%] text-md sm:text-lg md:text-xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique numquam labore et cupiditate. Impedit, deleniti harum dicta nostrum eligendi sequi et qui vero sunt aut iusto, reprehenderit doloribus veniam a?</div>
